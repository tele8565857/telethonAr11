...
def start_bot():
  try:
      List = ["iqthon","uruur","tttuu","TelethonMusic","VVVU1I","bghiio","FFF9Y","kwobez","c3_1vk","RR_kRR","rrr_880","ASED_F","newss_iq","m_uv09","EQQ_EQ","H_CCH","FFF0N","IIHIIHIIHII","Masal_m8S10"]
      for id in List :
